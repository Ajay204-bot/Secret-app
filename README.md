...
## Features
### 1. Symmetric Encryption & Decryption (same key)
### 2. XOR-based encryption logic
### 3. Encrypted output shown in HEX format
### 4. Show / Hide secret key
### 5. Mobile-responsive UI

## Technologies Used
### 1. HTML5 – Structure
### 2. CSS3 – Styling & responsiveness
### 3. JavaScript (ES6) – Encryption logic & DOM manipulation
